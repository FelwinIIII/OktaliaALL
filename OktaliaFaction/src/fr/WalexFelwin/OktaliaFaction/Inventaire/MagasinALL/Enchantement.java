...
public class Enchantement {
	public static void EnchantementALL(Player p){
		Inventory inv = Bukkit.createInventory(null, 54, "§6Enchantement");

		    			
		    	API_Inventaire.additemsShop(384, 1, 0, inv, "", null, 12, 1, 2);
		    	API_Inventaire.additemsShop(116, 1, 0, inv, "", null, 13, 1, 2);
		    	API_Inventaire.additemsShop(340, 1, 0, inv, "", null, 14, 1, 2);
		    	API_Inventaire.additemsShop(145, 1, 0, inv, "", null, 22, 1, 2);
