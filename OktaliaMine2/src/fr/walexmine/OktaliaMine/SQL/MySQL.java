	...
	private String pass = "";
	  ...
	  public static Connection openConnection()
	  {
	    ...
	    try
	    {
	      ...
	      System.out.println(ChatColor.GREEN+"OktaliaMine est bien connectée a la base de données");
	      return conn;
	    }
	    catch (SQLException e)
	    {
	      System.out.println(ChatColor.RED+"OktaliaMine n'est pas bien connectée a la base de données");
